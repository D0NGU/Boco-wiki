...
| DELETE | /api/user/delete | Request parametere: <br> userId og password | Streng med konfirmasjon <br> om at bruker ble slettet | Sletter en gitt bruker fra databasen. Sjekker at passordet <br>er riktig for å forhindre at en bruker<br> sletter en bruker den ikke eier. |
